...
Keep changes to model assumptions or results separate from formatting edits. Document changes to accounting boundaries, risk interpretation or expected outcomes. Preserve the frozen reference archive; write new experiments to a different output directory.
